...
#import "MediaPlayerRuntimeInfo.h"
#import "PlayerQueueManager.h"

@interface MediaPlayerRuntimeInfo()

@property (nonatomic, strong) PlayerQueueManager* playlistQueue;

-(instancetype)init;

@end

@implementation MediaPlayerRuntimeInfo

+(instancetype)sharedInstance{
    static dispatch_once_t onceToken;
    static MediaPlayerRuntimeInfo* sharedInstance;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[MediaPlayerRuntimeInfo alloc] init];
    });
...
-(instancetype)init{
    [super init];
    self.playlistQueue = [[[PlayerQueueManager alloc] init] retain];
    return self;
}
